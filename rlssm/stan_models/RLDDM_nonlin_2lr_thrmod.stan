data {
	...
	vector[2] threshold_modulation_priors;			// mean and sd of the prior
...
transformed parameters {
	...
	real transf_threshold_modulation;
	real transf_ndt;
...
model {
	...
	threshold_modulation ~ normal(threshold_modulation_priors[1], threshold_modulation_priors[2]);
