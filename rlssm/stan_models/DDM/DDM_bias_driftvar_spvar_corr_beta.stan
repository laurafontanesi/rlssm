data {
	...
	vector[2] beta_trialmu_priors;					// mean and sd of the prior
	vector[2] beta_trialsd_priors;					// mean and sd of the cauchy prior
}
parameters {
...
transformed parameters {
	...
	beta_trialmu = par_mean_vector[3];
	drift_trialsd = tau[1];
...
model {
	...
	par_mean_vector[3] ~ normal(beta_trialmu_priors[1], beta_trialmu_priors[2]);
	tau[1] ~ cauchy(drift_trialsd_priors[1], drift_trialsd_priors[2]);
	tau[2] ~ cauchy(rel_sp_trialsd_priors[1], rel_sp_trialsd_priors[2]);
	tau[3] ~ cauchy(beta_trialsd_priors[1], beta_trialsd_priors[2]);
