...
from rlssm import load_example_dataset, LBAModel_2A
from tests.plot_functions.common_methods import compute_MSE_error


def test_LBA_plot_posterior(print_results=True):
    ...
    ref_image_path = os.path.join(ref_fldr, 'ref_plot_post_lba.png')
